 ...
 */
 ...
 int main (int argc, char *argv[])
 {
   ...
   // Set up logging
   LogComponentEnable ("Scenario3", LOG_LEVEL_ALL);
   ...
   for (NodeContainer::Iterator j = endDevices.Begin ();
        j != endDevices.End (); ++j)
     {
       ...
       // Set message type to UNCONFIRMED_DATA_UP (non-ACK) for all end devices
   ...
   ********************************************/
   ...
   networkServerHelper.SetFileName ("scenario3.csv");
