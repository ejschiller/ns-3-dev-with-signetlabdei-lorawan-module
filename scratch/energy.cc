 ...
 *
 * Scenario E: Transmission of signed, confirmed multi-packet transactions
 *             and measuring energy consumption.
 */
 ...
 // Network settings
 int nDevices = 2;
 const int nGateways = 1;
 Time simulationTime = Hours (24);
 int dataPacketSize = 42;
 int partialSignaturePacketSize = 64;
 Time intraTransactionDelay = Seconds (60);
 Time interTransactionDelay = intraTransactionDelay;
 int packetsPerTransaction = 5;
 int signaturePacketsPerTransaction = 1;
 ...
 int main (int argc, char *argv[])
 {
   ...
   cmd.AddValue ("dPktsPerTrans",
                 "Number of data packets per signed multi-packet transaction",
   ...
   // Asserting the min. signing process time
   NS_ASSERT (intraTransactionDelay >= Seconds (6.15));
   ...
   ********************************************/
   ...
   networkServerHelper.SetFileName ("energy.csv");
   ...
   basicSourceHelper.Set ("BasicEnergySupplyVoltageV", DoubleValue (5.1));

   radioEnergyHelper.Set ("StandbyCurrentA", DoubleValue (0.087));
   radioEnergyHelper.Set ("TxCurrentA", DoubleValue (0.182));
   radioEnergyHelper.Set ("SleepCurrentA", DoubleValue (0.0000015));
   radioEnergyHelper.Set ("RxCurrentA", DoubleValue (0.103));
